...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    return function(t, e, i, n) {
        ...
        var d,
            ...
            p = !1;
        if (t.fn && t.fn.jquery ? (d = t, p = !0) : d = e.Velocity.Utilities, 8 >= c && !p)
            ...
            var y = v.CSS = {
                ...
                setPropertyValue: function(t, i, n, a, o) {
                    ...
                    if ("scroll" === i)
                        ...
                        y.Normalizations.registered[i]("inject", t, n), s = "transform", n = r(t).transformCache[i];
                    else {
                        if (y.Hooks.registered[i]) {
                            var l = i,
                                u = y.Hooks.getRoot(i);
                        ...
                        if (y.Normalizations.registered[i] && (n = y.Normalizations.registered[i]("inject", t, n), i = y.Normalizations.registered[i]("name", t)), s = y.Names.prefixCheck(i)[0], 8 >= c)
                            ...
                            r(t) && r(t).isSVG && y.Names.SVGAttribute(i) ? t.setAttribute(i, n) : t.style[s] = n;
                            ...
                            for (var O in r(o).tweensContainer && !0 === r(o).isAnimating && (I = r(o).tweensContainer), d.each(b, function(t, e) {
                                ...
                                if (r(o).isSVG || "tween" === W || !1 !== y.Names.prefixCheck(W)[1] || y.Normalizations.registered[W] !== n) {
                                    ...
                                    if (E = (H = p(O, E))[0], q = H[1], z = (H = p(O, z))[0].replace(/^([+-\/*])=/, function(t, e) {
                                        return Y = e, ""
                                    }), j = H[1], E = parseFloat(E) || 0, z = parseFloat(z) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(O) ? (z /= 100, j = "em") : /^scale/.test(O) ? (z /= 100, j = "") : /(Red|Green|Blue)$/i.test(O) && (z = z / 100 * 255, j = "")), /[\/*]/.test(Y))
                                        j = q;
                                    else if (q !== j && 0 !== E)
                                        if (0 === z)
                                            j = q;
                ...
                t.controllers.polarArea = t.DatasetController.extend({
                    ...
                    update: function(t) {
                        ...
                        for (a._updateRadius(), s.count = a.countVisibleElements(), e = 0, i = o.data.length; e < i; e++)
                            u[e] = l, n = a._computeAngle(e), d[e] = n, l += n;
            ...
            n._set("global", {
                ...
                advance: function(t) {
                    for (var e, i, n = this.animations, r = 0; r < n.length;)
                        i = (e = n[r]).chart, e.currentStep = (e.currentStep || 0) + t, e.currentStep = Math.min(e.currentStep, e.numSteps), a.callback(e.render, [i, e], i), a.callback(e.onAnimationProgress, [e], i), e.currentStep >= e.numSteps ? (a.callback(e.onAnimationComplete, [e], i), i.animating = !1, n.splice(r, 1)) : ++r
                }
            }
        }, {
            26: 26,
                    ...
                    buildOrUpdateScales: function() {
                        ...
                        i.scales && (a = a.concat((i.scales.xAxes || []).map(function(t) {
                            ...
                            if (s in n && n[s].type === l)
                                (u = n[s]).options = a, u.ctx = t.ctx, u.chart = t;
                            else {
                        ...
                        merger: function(t, e, i, n) {
                            if ("xAxes" === t || "yAxes" === t) {
                                ...
                                for (e[t] || (e[t] = []), a = 0; a < u; ++a)
                                    l = i[t][a], s = r.valueOrDefault(l.type, "xAxes" === t ? "category" : "linear"), a >= e[t].length && e[t].push({}), !e[t][a].type || l.type && l.type !== e[t][a].type ? r.merge(e[t][a], [o.getScaleDefaults(s), l]) : r.merge(e[t][a], l)
                            } else
                                r._merger(t, e, i, n)
                        }
                    })
                ...
                fit: function() {
                    ...
                    if (a.display && h) {
                        ...
                        if (f) {
                            ...
                            a.mirror ? v = 0 : v += x + y, e.width = Math.min(t.maxWidth, e.width + v), t.paddingTop = p.size / 2, t.paddingBottom = p.size / 2
                    }
                    ...
                    if (i.display) {
                        ...
                        if (r.each(m, function(n, a) {
                            ...
                            if (h.display && (a.save(), a.lineWidth = t.glWidth, a.strokeStyle = t.glColor, a.setLineDash && (a.setLineDash(t.glBorderDash), a.lineDashOffset = t.glBorderDashOffset), a.beginPath(), h.drawTicks && (a.moveTo(t.tx1, t.ty1), a.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (a.moveTo(t.x1, t.y1), a.lineTo(t.x2, t.y2)), a.stroke(), a.restore()), s.display) {
                                ...
                                var i = t.label;
                                if (r.isArray(i))
                                    for (var n = i.length, o = 1.5 * b.size, l = e.isHorizontal() ? 0 : -o * (n - 1) / 2, u = 0; u < n; ++u)
                            ...
                            var F,
                                ...
                                R = c(f) / 2;
                            if (g)
                                F = e.left + (e.right - e.left) / 2, O = "bottom" === i.position ? e.bottom - R - C.bottom : e.top + R + C.top;
                            else {
            ...
            (e.exports = a.extend({
                ...
                getCaretPosition: function(t, e, i) {
                    var n,
                        ...
                        m = e.height;
                    if ("center" === h)
                        s = p + m / 2, "left" === c ? (a = (n = f) - u, r = n, o = s + u, l = s - u) : (a = (n = f + g) + u, r = n, o = s - u, l = s + u);
                    else if ("left" === c ? (n = (a = f + d + u) - u, r = a + u) : "right" === c ? (n = (a = f + g - d - u) - u, r = a + u) : (n = (a = i.caretX) - u, r = a + u), "top" === h)
                        s = (o = p) - u, l = o;
                    else {
                        s = (o = p + m) + u, l = o;
                        var v = r;
                ...
                drawTitle: function(t, e, i, n) {
                    ...
                    if (a.length) {
                        ...
                        for (i.fillStyle = s(e.titleFontColor, n), i.font = r.fontString(u, e._titleFontStyle, e._titleFontFamily), o = 0, l = a.length; o < l; ++o)
                            i.fillText(a[o], t.x, t.y), t.y += u + d, o + 1 === a.length && (t.y += e.titleMarginBottom - d)
                    }
                },
        ...
        42: [function(t, e, i) {
            ...
            i = e.exports = {
                ...
                lineTo: function(t, e, i, n) {
                    if (i.steppedLine)
                        return "after" === i.steppedLine && !n || "after" !== i.steppedLine && n ? t.lineTo(e.x, i.y) : t.lineTo(i.x, e.y), void t.lineTo(i.x, i.y);
            ...
            e.exports = {
                ...
                afterDatasetsUpdate: function(t, e) {
                    var i,
                        ...
                        f = [];
                    for (n = 0; n < c; ++n)
                        o = null, (r = (i = t.getDatasetMeta(n)).dataset) && r._model && r instanceof a.Line && (o = {
                            ...
                            x ? m + g >= s && (v = d.y += w, d.line++, m = d.x = t.left + (s - u[d.line]) / 2) : v + w > t.bottom && (m = d.x = m + t.columnWidths[d.line] + i.padding, v = d.y = t.top + i.padding, d.line++), function(t, i, n) {
                                if (!(isNaN(b) || b <= 0)) {
                                    ...
                                    if (c.setLineDash && c.setLineDash(h(n.lineDash, o.borderDash)), e.labels && e.labels.usePointStyle) {
                                        ...
                                        s || c.strokeRect(t, i, b, p), c.fillRect(t, i, b, p);
                                    c.restore()
                                }
            ...
            function b(t, e, i, a) {
                var o,
                    ...
                    l = s.unit || function(t, e, i, n) {
                        ...
                        for (a = c.indexOf(t); a < s - 1; ++a)
                            if (o = (r = d[c[a]]).steps ? r.steps[r.steps.length - 1] : u, r.common && Math.ceil((i - e) / (o * r.size)) <= n)
                                return c[a];
                        return c[s - 1]
                    }(s.minUnit, t, e, i),
                    h = v(l),
                ...
                for (f || (f = function(t, e, i, n) {
                    ...
                    for (a = 0, r = c.length; a < r && (o = c[a], !(Math.ceil(s / (u * o)) <= n)); ++a)
                        ;
                    return o
                }(t, e, l, i)), p && (b = b.isoWeekday(p), y = y.isoWeekday(p)), b = b.startOf(p ? "day" : l), (y = y.startOf(p ? "day" : l)) < e && y.add(1, l), o = n(b), g && h && !p && !s.round && (o.startOf(h), o.add(~~((b - o) / (m.size * f)) * f, l)); o < y; o.add(f, l))
                    x.push(+o);
                return x.push(+o), x
            }
            e.exports = function() {
                var t = o.extend({
                        ...
                        for (t = 0, i = (c.data.datasets || []).length; t < i; ++t)
                            if (c.isDatasetVisible(t))
                                if (o = c.data.datasets[t].data, r.isObject(o[0]))
                                    ...
                                    y.push.apply(y, w), x[t] = w.slice(0);
                            else
                                x[t] = [];
                    ...
                    buildTicks: function() {
                        ...
                        }(a._timestamps.data, l), function(t, e) {
                            var i,
                                a,
                                r,
                                o,
                ...
                t(".wow").each(function() {
                    ...
                    i ? (e = window.innerHeight, r = window.scrollY, t(".wow.animated").each(function() {
                        if (e + r - 100 > a(this) && r > a(this) + 100 || e + r - 100 < a(this) && r < a(this) + 100 || a(this) + t(this).height > t(document).height() - 100)
                            t(this).removeClass("animated"), t(this).css({
                                "animation-name": "none"
                            }), t(this).css({
                                visibility: "hidden"
                            });
    ...
    function h(t) {
        ...
        if (null !== e) {
            ...
            if (c.registerEvent(t), "touchstart" === t.type && l.delay) {
                ...
                l.show(t, e), n && (e.addEventListener("touchend", l.hide, !1), e.addEventListener("touchcancel", l.hide, !1)), e.addEventListener("mouseup", l.hide, !1), e.addEventListener("mouseleave", l.hide, !1)
        }
    }
...
!function(t) {
    var e,
        i,
        n = "".concat(["text", "password", "email", "url", "tel", "number", "search", "search-md"].map(function(t) {
