...
function init_flot_chart() {
    ...
    var dayss = 7;
    var degerler = 6;
    var element = document.getElementById("aylikSatisGrafik");
    var element2 = document.getElementById("aylikGiderGrafik");
    var element3 = document.getElementById("aylikCiroGrafik");
    var liste;
    var liste2;
    var liste3;
    if (element != null) {
    ...
    if (element3 != null) {
        liste3 = element3.value;
        liste3 = liste3.substring(1);
        liste3 = liste3.substring(0, liste3.length - 1);
        var sp3 = liste3.split(",");
    } else {
        liste3 = null;
    }
    if (element2 != null) {
        liste2 = element2.value;
        liste2 = liste2.substring(1);
        liste2 = liste2.substring(0, liste2.length - 1);
        var sp2 = liste2.split(",");
    ...
    if ("undefined" != typeof $.plot) {
        ...
        for (var a = [
            [gd(year, month, day - 7), sp3[6]],
            [gd(year, month, day - 6), sp3[5]],
            [gd(year, month, day - 5), sp3[4]],
            [gd(year, month, day - 4), sp3[3]],
            [gd(year, month, day - 3), sp3[2]],
            [gd(year, month, day - 2), sp3[1]],
            [gd(year, month, day - 1), sp3[0]]
        ], b = [
            [gd(year, month, day - 7), 82],
            [gd(year, month, day - 6), 23],
            [gd(year, month, day - 5), 66],
            [gd(year, month, day - 4), 9],
            [gd(year, month, day - 3), 119],
            [gd(year, month, day - 2), 6],
            [gd(year, month, day - 1), 9]
        ], d = [], d2 = [], e = [
            [0, 1],
            [1, 9],
            [2, 6],
            ...
            d.push([gd(year, month, day - dayss), sp[degerler]]);
            d2.push([gd(year, month, day - dayss--), sp2[degerler--]]);
        }
        var g = {
            series: {
                lines: {
        ...
        $("#chart_plot_01").length && (console.log("Plot1"), $.plot($("#chart_plot_01"), [a], g)), $("#chart_plot_02").length && (console.log("Plot2"), $.plot($("#chart_plot_02"), [{
                data: d,
                lines: {
        ...
        $("#chart_plot_021").length && (console.log("Plot2"), $.plot($("#chart_plot_021"), [{
                data: d2,
                lines: {
                    fillColor: "rgba(150, 202, 89, 0.12)"
                },
...
function init_daterangepicker_reservation1() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation1"), $("#reservation1").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation2() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation2"), $("#reservation2").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation3() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation3"), $("#reservation3").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation4() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation4"), $("#reservation4").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation5() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation5"), $("#reservation5").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation6() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation6"), $("#reservation6").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation7() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation7"), $("#reservation7").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation8() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation8"), $("#reservation8").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation9() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation9"), $("#reservation9").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation10() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation10"), $("#reservation10").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation11() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation11"), $("#reservation11").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation12() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation12"), $("#reservation12").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation13() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation13"), $("#reservation13").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation14() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation14"), $("#reservation14").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation15() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation15"), $("#reservation15").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_daterangepicker_reservation16() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation16"), $("#reservation16").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
...
function init_SmartWizard() {
    ...
    }), $(".buttonNext").addClass("btn btn-success"), $(".buttonNext").attr("id", "nextButton"), $(".buttonPrevious").addClass("btn btn-primary"), $(".buttonPrevious").attr("id", "prevButton"), $(".buttonFinish").addClass("btn btn-default"), $(".buttonFinish").attr("id", "finishButton")),
